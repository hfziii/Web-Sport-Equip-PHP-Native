...
<?php
    ...
    if (isset($_GET['kode'])) {
        ...
        $sql = "DELETE FROM catalog_sport_equip WHERE kode='$kode'";
...
<html lang="en">
    ...
    <head>
        ...
        <title>Katalog Barang-Admin</title>

        <link href="css/catalog.css?v=<?php echo time(); ?>" rel="stylesheet">
        ...
        <div class="bg-base-body">
            ...
            <div class="bg-body-item">
                ...
                <div class="icon-sidebar">
                    ...
                    <a href="#">
                        <div class="menu-5">
                            <img src="./img/catalog/listrent-icon.png" alt="" class="icon-5">
                ...
                <div class="content">
                    ...
                    <p class="title-content">Katalog Barang</p>
                    <a href="create.php">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="col-kode">Kode</th>
                                <th scope="col" class="col-nama">Nama Barang</th>
                                <th scope="col" class="col-kategori">Kategori</th>
                                <th scope="col" class="col-kategori">Foto</th>
                                <th scope="col" class="col-stok">Stok</th>
                                <th scope="col" class="col-harga">Harga</th>
                                <th scope="col" class="col-status">Status</th>
                                <th scope="col" class="col-status">Deskripsi</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                $no = 1;
                                $query = mysqli_query($connection, "SELECT * FROM catalog_sport_equip");
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo $data['foto']; ?>" alt="<?php echo $data['nama_barang']; ?>" style="width: 70px; height: auto;"></td>
                                <td><?php echo $data['stok']; ?></td>
                                <td><?php echo 'Rp ' . number_format($data['harga'], 2, ',','.') . ' /hari'; ?></td>
                                <td><?php echo $data['status']; ?></td>
                                <td><?php echo $data['deskripsi']; ?></td>
                                
                                <td>
                                    <a href="update.php?kode=<?php echo htmlspecialchars($data['kode']); ?>">
                                        <img src="./img/catalog/edit-icon.png" alt="" class="act-btn edit">
                                    </a>
                                    
                                    <a href="#" onclick="confirmDelete('<?php echo $data['kode']; ?>');">
        ...
        <script>
            function confirmDelete(kode) {
                if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
                    window.location.href = "catalog.php?kode=" + kode;
                }
            }
        </script>
