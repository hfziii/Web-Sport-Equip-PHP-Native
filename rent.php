...
<?php
    ...
    if (isset($_GET['id_rental'])) {
        $id_rental = htmlspecialchars($_GET["id_rental"]);
...
<head>
    ...
    <link href="css/rent.css?v=<?php echo time(); ?>" rel="stylesheet">
...
<body>
    <div class="bg-base-body">
        ...
        <div class="bg-body-item">
            ...
            <div class="icon-sidebar">
                ...
                <a href="#">
                    <div class="menu-3">
                        <img src="./img/catalog/icon-rent2.png" alt="" class="icon-3">
            ...
            <!-- CONTENT -->
            <div class="content">
                <p class="title-content">Data Sewa</p>
                <a href="#">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="col-idr">Id Retal</th>
                            <th scope="col" class="col-idu">Id User</th>
                            <th scope="col" class="col-tanggal">Tanggal</th>
                            <th scope="col" class="col-nama">Nama Penyewa</th>
                            <th scope="col" class="col-alamat">Alamat</th>
                            <th scope="col" class="col-alamat">Total Bayar</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            $no = 1;
                            $query = mysqli_query($connection, "SELECT * FROM rental");
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="update-rent.php?kode=<?php echo htmlspecialchars($data['id_rental']); ?>">
                                    <img src="./img/catalog/edit-icon.png" alt="" class="act-btn edit">
                                </a>
                                
                                <a href="#" onclick="confirmDelete('<?php echo $data['id_rental']; ?>');">
    ...
    <script>
        function confirmDelete(id_rental) {
            if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
                window.location.href = "catalog.php?id_rental=" + id_rental;
            }
        }
    </script>
</body>
