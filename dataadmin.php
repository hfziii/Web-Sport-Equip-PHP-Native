...
<html lang="en">
    ...
    <head>
        ...
        <link href="css/dataadmin.css?v=<?php echo time(); ?>" rel="stylesheet">
        ...
        <div class="bg-base-body">
            ...
            <div class="bg-body-item">
                ...
                <div class="icon-sidebar">
                        ...
                        <div class="menu-1">
                            <img src="./img/catalog/profile-icon-menu1.png" alt="" class="icon-1">
                ...
                <div class="content">
                    ...
                    <p class="title-content">Kelola Admin</p>
                    <a href="#">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th scope="col" class="col-id_admin">Id User</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#?id_admin=<?php echo htmlspecialchars($data['id_admin']); ?>">
                                        <img src="./img/catalog/edit-icon.png" alt="" class="act-btn edit">
                                    </a>
                                    
                                    <a href="#" onclick="confirmDelete('<?php echo $data['id_admin']; ?>');">
